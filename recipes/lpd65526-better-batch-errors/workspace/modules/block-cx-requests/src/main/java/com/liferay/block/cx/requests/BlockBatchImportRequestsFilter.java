...
@Component(
        ...
        property = {
                ...
                "servlet-filter-name=Block Batch Import Requests Servlet Filter",
                "url-pattern=/o/headless-batch-engine/*"
        },
        service = Filter.class
)
public class BlockBatchImportRequestsFilter extends BaseFilter {
    ...
    private static final Log _log = LogFactoryUtil.getLog(
            BlockBatchImportRequestsFilter.class);
